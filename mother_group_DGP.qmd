...
head(df[, .SD, .SDcols = c("id_district","x_dob","x_age","x_parity","id_mother_group","y_lsupply")],n=20)
...
for (i in 1:I){
   ...
   # 2 recenter
       res<-feols(y_lsupply~x_lsupply_peers_rc+x_schooling+x_schooling_m1+x_income+x_income_m1|id_district+x_quarter+x_young+x_parity,data=mydata,notes=FALSE)
